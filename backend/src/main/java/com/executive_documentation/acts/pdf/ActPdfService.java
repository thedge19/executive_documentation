...
// --------------------------------------------------------------------------------------------------------------------------------
    ...
    private void addFirstStaticBlock(PdfPTable table) {
        table.addCell(createCell("", "centerNoBorder", f5, 23, 1, 0.0F));
        table.addCell(createCell("Приказ Минстроя  №344/пр от 16.05.2023", "rightCenterNoBorder", f5, 13, 1, 0.0F));
        table.addCell(createCell("", "centerNoBorder", f5, 31, 1, 0.0F));
        table.addCell(createCell("приложение №3", "rightCenterNoBorder", f5, 5, 1, 0.0F));
